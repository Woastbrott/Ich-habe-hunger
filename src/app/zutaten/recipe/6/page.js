...
export default function Recipe1() {
  return (
    <main className="bg-white flex flex-col items-center justify-between">
      ...
      <h1 className="text-4xl text-black bg-gradient-to-r from-gray-200 to-gray-600 rounded-2xl pr-20 pl-20 p-4 mt-5 font-bold inline-block">Asia Garlic Noodles</h1>
      ...
      <div className="flex flex-col items-center h-screen w-screen text-black ml-8 mt-8">
        ...
        <button
          onClick={() => window.location.href = "https://www.tiktok.com/@i.am.never.full/video/7437130140976516383"} 
